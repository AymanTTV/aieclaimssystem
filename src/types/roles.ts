...
export const DEFAULT_PERMISSIONS: Record<Role, RolePermissions> = {
  ...
  manager: {
    ...
    maintenance: { ...BASE_MAINTENANCE, view: true, create: true, update: true, delete: true, cards: true, export: true, tableStatus: true, complete: true, completed: true, singleDoc: true, categories: true, whatsapp: true, email: true, send: true, reminder: true, mondayAutoEmail: true, template: true, templateCreate: true, templateEdit: true, templateDelete: true, reminderTemplate: true, messageTemplate: true },
    rentals: { ...BASE_RENTALS, view: true, create: true, update: true, delete: true, cards: true, daily: true, weekly: true, claim: true, export: true, syncStatus: true, singleDoc: true, availableVehicles: true, completion: true, discount: true, note: true, recordPayment: true, viewPayment: true, editPayment: true, deletePayment: true, reminder: true, mondayAutoEmail: true, bulkEmailScheduler: true, whatsapp: true, email: true, send: true, template: true, templateCreate: true, templateEdit: true, templateDelete: true, reminderTemplate: true, messageTemplate: true },
  ...
  admin: {
    ...
    maintenance: { ...BASE_MAINTENANCE, view: true, cards: true, export: true, tableStatus: true, completed: true, singleDoc: true, whatsapp: true, email: true, send: true, reminder: true, mondayAutoEmail: true, template: true, templateCreate: true, templateEdit: true, templateDelete: true, reminderTemplate: true, messageTemplate: true },
    utilisation: { ...BASE_UTILISATION, view: true, export: true, singleDoc: true },
    rentals: { ...BASE_RENTALS, view: true, cards: true, daily: true, weekly: true, claim: true, export: true, singleDoc: true, availableVehicles: true, note: true, recordPayment: true, viewPayment: true, editPayment: true, deletePayment: true, reminder: true, mondayAutoEmail: true, bulkEmailScheduler: true, whatsapp: true, email: true, send: true, template: true, templateCreate: true, templateEdit: true, templateDelete: true, reminderTemplate: true, messageTemplate: true },
    accidents: { ...BASE_ACCIDENTS, view: true, cards: true, export: true, singleDoc: true, driverRisk: true, renewalAnalysis: true },
    claims: { ...BASE_CLAIMS, view: true, cards: true, export: true, note: true, singleDoc: true, progressview: true, progressedit: true, groups: true, departments: true, assign: true, recordsPermission: true, email: true, whatsapp: true, send: true, reminder: true, mondayAutoEmail: true, template: true, templateCreate: true, templateEdit: true, templateDelete: true, reminderTemplate: true, messageTemplate: true },
    ...
    vdInvoice: { ...BASE_VD_INVOICE, view: true, create: true, cards: true, singleDoc: true, whatsapp: true, email: true, send: true, reminder: true, mondayAutoEmail: true, template: true, templateCreate: true, templateEdit: true, templateDelete: true, reminderTemplate: true, messageTemplate: true },
    driverPay: { ...BASE_DRIVER_PAY, view: true, create: true, update: true, delete: true, recordPayment: true, cards: true, export: true, lock: true, unlock: true, singleDoc: true, period: true, whatsapp: true, email: true, send: true, reminder: true, mondayAutoEmail: true, template: true, templateCreate: true, templateEdit: true, templateDelete: true, reminderTemplate: true, messageTemplate: true },
