...
const Customers = () => {
  ...
  // Modal state for bulk updating status
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          {/* BULK ACTIONS RENDERED IF ROWS ARE SELECTED */}
          {selectedCount > 0 && can('customers', 'update') && (
             <div className="flex items-center bg-blue-50 border border-blue-200 rounded-md px-3 py-1 mr-2 shadow-sm">
               ...
               <button 
                 ...
                 className="text-sm bg-blue-600 text-white hover:bg-blue-700 px-3 py-1.5 rounded flex items-center transition-colors"
               >
        ...
        <div className="space-y-6">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500 mt-1">
              You are updating the status for <strong>{selectedCount}</strong> selected member(s).
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className="flex flex-col items-center justify-center p-6 border-2 border-green-200 bg-green-50 rounded-xl hover:bg-green-100 hover:border-green-300 transition-all group"
            >
            ...
            <button
              ...
              className="flex flex-col items-center justify-center p-6 border-2 border-gray-200 bg-gray-50 rounded-xl hover:bg-gray-100 hover:border-gray-300 transition-all group"
            >
              <div className="bg-white p-3 rounded-full shadow-sm mb-3 group-hover:scale-110 transition-transform">
