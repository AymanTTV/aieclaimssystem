...
//   // Filter hooks
//   const { searchQuery, setSearchQuery, startDate, setStartDate, endDate, setEndDate, type, setType, category, setCategory, paymentStatus, setPaymentStatus, owner, setOwner, uniqueOwners, filteredTransactions } = useFinanceFilters(transactions, vehicles);
...
//   // New filteredInvoices logic, applying searchQuery as well
//   const filteredInvoices = invoices.filter(invoice => {
//     const searchQueryLower = searchQuery.toLowerCase();
//     return (
//       (invoice.invoiceNumber?.toLowerCase() ?? '').includes(searchQueryLower) ||
//       (invoice.customerName?.toLowerCase() ?? '').includes(searchQueryLower) ||
//       (invoice.vehicleModel?.toLowerCase() ?? '').includes(searchQueryLower) // Add more fields as needed
//     );
//   });
