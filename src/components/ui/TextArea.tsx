    ...
    return (
      <div className="space-y-1.5">
        ...
        <textarea
          ref={ref}
          rows={props.rows || 4}
          className={`form-textarea block w-full rounded-lg bg-white text-gray-950 font-medium placeholder:text-gray-400 border transition-all text-sm p-3 shadow-2xs ${
            error
