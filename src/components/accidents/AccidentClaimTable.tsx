...
import { Eye, Edit, Trash2, FileText, RefreshCw } from 'lucide-react'; // Added RefreshCw
...
interface AccidentClaimTableProps {
  ...
  onUpdateStatus: (accident: Accident) => void; // New Prop
...
const AccidentClaimTable: React.FC<AccidentClaimTableProps> = ({
  ...
  onEdit,
  onDelete,
  onUpdateStatus, // Destructure new prop
  onGenerateDocument,
  onViewDocument
}) => {
