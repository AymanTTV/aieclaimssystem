...
import { Car, User, Mail, Phone, Link2 } from 'lucide-react';
...
const TransactionDetailsModal: React.FC<TransactionDetailsProps> = ({
    ...
    try {
      if ((date as Timestamp)?.toDate) {
        ...
        dateObj = date;
         ...
         // Attempt parsing string formats
  ...
  // Helper to get account names string
  ...
  return (
    <div className="space-y-6 pb-2"> {/* Added padding bottom */}
      {/* Basic Information */}
