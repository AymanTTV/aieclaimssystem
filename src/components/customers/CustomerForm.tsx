  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <FormField type="tel" label="Mobile" value={formData.mobile} onChange={(e) => setFormData({ ...formData, mobile: e.target.value })} required />
        <FormField type="email" label="Email" value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} />
        ...
        {!isCompany && (
          <>
            ...
            <FormField label="Driver License Number" value={formData.driverLicenseNumber} onChange={(e) => setFormData({ ...formData, driverLicenseNumber: e.target.value })} required />
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="mt-1 flex items-center space-x-4">
                {documentPreviews.licenseFront && <img src={documentPreviews.licenseFront} alt="License Front" className="h-20 w-32 object-cover rounded-md" />}
                <label className="cursor-pointer inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                  <Upload className="h-5 w-5 mr-2 text-gray-400" /> Upload <input type="file" className="hidden" accept="image/*" onChange={handleDocumentChange('licenseFront')} />
                </label>
              </div>
            </div>
            {/* License Back */}
            <div>
              ...
              <div className="mt-1 flex items-center space-x-4">
                {documentPreviews.licenseBack && <img src={documentPreviews.licenseBack} alt="License Back" className="h-20 w-32 object-cover rounded-md" />}
                <label className="cursor-pointer inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                  <Upload className="h-5 w-5 mr-2 text-gray-400" /> Upload <input type="file" className="hidden" accept="image/*" onChange={handleDocumentChange('licenseBack')} />
                </label>
              </div>
            </div>
            {/* Bill Document */}
            <div>
              ...
              <div className="mt-1 flex items-center space-x-4">
                {documentPreviews.billDocument && <img src={documentPreviews.billDocument} alt="Bill Document" className="h-20 w-32 object-cover rounded-md" />}
                <label className="cursor-pointer inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                  <Upload className="h-5 w-5 mr-2 text-gray-400" /> Upload <input type="file" className="hidden" accept="image/*,.pdf" onChange={handleDocumentChange('billDocument')} />
                </label>
              </div>
            </div>
          </div>
      ...
      <div className="flex justify-end space-x-3">
        ...
        <button type="submit" disabled={loading} className="px-4 py-2 text-sm font-medium text-white bg-primary border border-transparent rounded-md hover:bg-primary-600 disabled:bg-gray-400">
