...
interface Props {
  onClose: () => void;
  collectionName: string; // e.g., 'incomeExpenseCategories'
}

export default function ManageIECategoriesModal({ onClose, collectionName }: Props) {
  ...
  const handleSaveEdit = async () => {
    ...
    setLoading(true);
    try {
      await updateDoc(doc(db, collectionName, editingId), { name: trimmed });
