  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        {rental.type === 'claim' && rental.documents?.noticeOfRightToCancel && (
          <button
        ...
        {rental.type === 'claim' && rental.documents?.hireAgreement && (
          <button
        ...
        {rental.type === 'claim' && rental.documents?.creditStorageAndRecovery && (
          <button
