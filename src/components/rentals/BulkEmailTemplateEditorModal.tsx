...
export const BulkEmailTemplateEditorModal: React.FC<BulkEmailTemplateEditorModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-60 bg-black/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
      <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 w-full max-w-4xl overflow-hidden flex flex-col max-h-[92vh] animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="sm:col-span-2">
              ...
              <input
                ...
                className="w-full text-xs font-semibold px-3 py-2 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
            </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-2 px-3 py-2 bg-slate-100 border border-gray-200 rounded-xl text-xs font-bold text-gray-700">
          ...
          <div className="p-3 bg-slate-50 border border-indigo-100 rounded-2xl">
            ...
            <div className="flex flex-wrap gap-1.5">
              {AVAILABLE_PLACEHOLDERS.map(p => (
                <button
                  ...
                  title={p.desc}
                  className="px-2 py-1 bg-white hover:bg-indigo-50 text-indigo-700 hover:text-indigo-900 border border-indigo-200 hover:border-indigo-300 rounded-lg text-[11px] font-mono font-bold transition shadow-2xs cursor-pointer"
                >
                  {p.tag}
                </button>
              ))}
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full text-xs font-medium font-mono p-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-white leading-relaxed"
            />
          </div>
          ...
          {showPreview && (
            <div className="p-4 bg-indigo-50/60 border border-indigo-200 rounded-2xl">
              ...
              <div className="bg-white p-3.5 rounded-xl border border-indigo-100 text-xs shadow-2xs space-y-2">
                <p className="font-bold text-gray-900 pb-1.5 border-b border-gray-100">
                  <span className="text-gray-500 font-normal">Subject:</span> {previewSubject || '(Empty Subject)'}
                </p>
                <div className="text-gray-700 whitespace-pre-wrap font-sans text-xs leading-relaxed">
        ...
        {/* Footer Actions */}
        <div className="p-4 sm:p-5 bg-slate-50 border-t border-gray-200 flex items-center justify-between gap-3">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-2 text-xs font-bold text-gray-600 hover:text-gray-800 bg-white hover:bg-gray-100 rounded-xl border border-gray-200 transition"
          >
            Cancel
          </button>
          ...
          <div className="flex items-center gap-2">
            {mode === 'edit' && (
              <button
                ...
                disabled={saving}
                className="px-3.5 py-2 text-xs font-bold text-indigo-700 bg-indigo-50 hover:bg-indigo-100 rounded-xl border border-indigo-200 transition disabled:opacity-50"
              >
